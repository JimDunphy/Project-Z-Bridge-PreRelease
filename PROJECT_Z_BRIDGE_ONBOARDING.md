...
For a developer-level walkthrough of one real request path, from clicking a mail
row in ZWC through `GetMsgRequest`, JMAP `Email/get`, and `GetMsgResponse`, see
[developer/ARCHITECTURE_ZWC_SOAP_LIFECYCLE.md](developer/ARCHITECTURE_ZWC_SOAP_LIFECYCLE.md).
...
- [developer/ARCHITECTURE.md](developer/ARCHITECTURE.md) for the technical
  architecture map.
- [developer/ARCHITECTURE_ZWC_SOAP_LIFECYCLE.md](developer/ARCHITECTURE_ZWC_SOAP_LIFECYCLE.md)
  for how ZWC uses SOAP and how a mail-row click flows through the bridge.
