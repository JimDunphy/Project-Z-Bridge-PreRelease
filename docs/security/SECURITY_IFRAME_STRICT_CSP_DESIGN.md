...
Quick sequence view:
1. [`SECURITY_IFRAME_STRICT_CSP_SEQUENCE.md`](SECURITY_IFRAME_STRICT_CSP_SEQUENCE.md)
2. [`SECURITY_IFRAME_CSP_HEADER_VERIFICATION.md`](SECURITY_IFRAME_CSP_HEADER_VERIFICATION.md)
