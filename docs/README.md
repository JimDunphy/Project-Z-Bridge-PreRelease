...
- Documentation audit / cleanup: [`DOCUMENTATION_AUDIT.md`](DOCUMENTATION_AUDIT.md)
- Live bugs and pending verification: [`BUGS.md`](BUGS.md)
- Deferred gaps / future debt: [`FUTURE_GAPS.md`](FUTURE_GAPS.md)
- Resolved bug archive / debugging memory: [`BUGS_RESOLVED.md`](BUGS_RESOLVED.md)
- Current status / handoff notes: [`STATUS.md`](STATUS.md)
- Detailed handoff archive: [`STATUS_DETAILED_HANDOFF_ARCHIVE.md`](STATUS_DETAILED_HANDOFF_ARCHIVE.md)
...
- **Cache/performance tuning**: [`sysadmin/SYSADMIN_CACHE_TUNING_GUIDE.md`](sysadmin/SYSADMIN_CACHE_TUNING_GUIDE.md)
...
- **Cache/performance developer audit**: [`developer/PERFORMANCE_CACHE_AUDIT.md`](developer/PERFORMANCE_CACHE_AUDIT.md)
...
- Future Tasks and Briefcase designs: [`developer/TASKS_DESIGN.md`](developer/TASKS_DESIGN.md), [`developer/BRIEFCASE_DESIGN.md`](developer/BRIEFCASE_DESIGN.md)

## Archived / Historical Docs

These are still useful references, but are not required for day-to-day maintenance:

- [`archive/README.md`](archive/README.md) (archive rules and current-reference pointers)
- [`archive/ARCHITECTURE_DESIGN_HISTORICAL.md`](archive/ARCHITECTURE_DESIGN_HISTORICAL.md) (early technical design; historical)
- [`archive/DEV_CODEX_CONTEXT.md`](archive/DEV_CODEX_CONTEXT.md) (agent snapshot; historical)
- [`archive/DependencyAnalysis.md`](archive/DependencyAnalysis.md) (one-off analysis; historical)

Additional optional background that could move later:

- [`WhyUseRust.md`](WhyUseRust.md) (background / positioning, not a current implementation reference)
...
Known live issues are tracked in [`BUGS.md`](BUGS.md). Deferred gaps live in
[`FUTURE_GAPS.md`](FUTURE_GAPS.md), and resolved incident memory lives in
[`BUGS_RESOLVED.md`](BUGS_RESOLVED.md).
